...
pub fn draw_island(
    ...
    if expanded_alpha_f > 0.01 {
        ...
        draw_main_page(canvas, offset_x, offset_y, current_w, current_h, alpha, media, music_active, view_offset, global_scale, expansion_progress, viz_h_scale * global_scale, use_blur, font_size);
        canvas.restore();
